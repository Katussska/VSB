...
{
    if (this->clientsCount < this->clientsMax)
    {
...
Account *Bank::createAccount(int number, Client *owner, Client *partner)
{
    if (accountsCount < accountsMax)
    {
        Account *newAccount = new Account(number, owner, partner);
...
Account *Bank::createAccount(int number, Client *owner, Client *partner, double interest)
{
    if (accountsCount < accountsMax)
    {
        Account *newAccount = new Account(number, owner, partner, interest);
