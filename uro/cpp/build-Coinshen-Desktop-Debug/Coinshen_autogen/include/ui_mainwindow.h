...
public:
    ...
    void setupUi(QMainWindow *Coinshen)
    {
        ...
        columnView->setGeometry(QRect(260, 200, 511, 351));
        verticalScrollBar = new QScrollBar(centralwidget);
        verticalScrollBar->setObjectName("verticalScrollBar");
        verticalScrollBar->setGeometry(QRect(750, 200, 21, 351));
        verticalScrollBar->setOrientation(Qt::Vertical);
        calendar = new QCalendarWidget(centralwidget);
        calendar->setObjectName("calendar");
        calendar->setGeometry(QRect(380, 10, 304, 179));
