%Dodělat matici řádek 169

\documentclass[czech,10pt,a4paper,twoside]{article}
\usepackage[utf8]{inputenc}
\usepackage[backend=biber,style=numeric]{biblatex}
\usepackage[czech]{babel}
\usepackage[top=30mm,bottom=35mm,left=20mm,right=30mm]{geometry}
...
\definecolor{indentifiercolor}{HTML}{2599B2}
...
\fancyfoot[LO,RE]{Kateřina Baierová, BAI0033}
...
\begin{table}[ht]
    ...
    \begin{tabular}{l S S}
        \toprule
        \textbf{Metoda}                  & {\makecell{Experiment          \\ $\alpha$}} & {\makecell{Experiment \\ $\beta$}} \\
        \midrule
        \rowcolor{orange} Gauss          & 1234.5                & 123.4  \\
        $\chi^2$                         & 12.34                 & 12.345 \\
        \rowcolor{orange} Student t-test & 111.99                & 11.999 \\
        Normal distribution              & 111.99                & 11.999 \\
        \rowcolor{orange} Quantum        & 7.7                   & 7.7777 \\
        \bottomrule
    \end{tabular}
